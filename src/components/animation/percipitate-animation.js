  ...
  circle(idx, top, left) { //#e7c983
      return (
        ...
        >
            ...
            <g><g><use
            xlinkHref="#bXGC1yIOo" opacity="1" fill="currentColor" fill-opacity="1"></use><g><filter id="shadow1609340" x="126" y="250.63" width="91.35" height="83.31" filterUnits="userSpaceOnUse" primitiveUnits="userSpaceOnUse"><feFlood></feFlood><feComposite in2="SourceAlpha" operator="out"></feComposite><feGaussianBlur stdDeviation="2.83"></feGaussianBlur><feOffset dx="2" dy="-2" result="afterOffset"></feOffset><feFlood flood-color="#9e9e9e" flood-opacity="0.8"></feFlood><feComposite in2="afterOffset" operator="in"></feComposite><feMorphology operator="dilate" radius="1"></feMorphology><feComposite in2="SourceAlpha" operator="in"></feComposite></filter><path d="M191.35 291.28C191.35 300.48 182.09 307.94 170.68 307.94C159.26 307.94 150 300.48 150 291.28C150 282.09 159.26 274.63 170.68 274.63C182.09 274.63 191.35 282.09 191.35 291.28Z" id="cp8lgKNjG" fill="white" fill-opacity="1" filter="url(#shadow1609340)"></path></g></g></g>
